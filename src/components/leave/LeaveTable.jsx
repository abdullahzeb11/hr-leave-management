            ...
            return (
              <tr key={r.id} className="hover:bg-slate-50/60">
                  ...
                  <td className="px-4 py-3">
                    <div className="flex items-center gap-2.5">
                      ...
                      <div className="leading-tight">
                        <div className="text-sm font-medium text-slate-900">{employee?.name[lang]}</div>
                        <div className="text-xs text-slate-500">{employee?.title[lang]}</div>
                      </div>
                    </div>
                  </td>
                )}
                ...
                <td className="px-4 py-3 text-slate-700">
                  ...
                  <div className="text-xs text-slate-500">→ {formatDate(r.to, lang)}</div>
                </td>
                <td className="px-4 py-3 font-semibold text-slate-900">{r.days}</td>
                <td className="px-4 py-3 max-w-[220px] truncate text-slate-600" title={r.reason}>{r.reason || '—'}</td>
                <td className="px-4 py-3">
